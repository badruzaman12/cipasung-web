...
<i class="fas fa-school"></i>  Form Tambah Data KRP
    </div>
    <form method="post" action="<?php echo base_url('administraktor/krp/tambah_krp_aksi') ?>">
    ...
    <div class="form-group">
        ...
        <input type="hidden" name="id_santri" class="form-control"<?php echo $nama; ?>>
